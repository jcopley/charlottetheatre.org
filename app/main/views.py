...
def edit_post(id):
    ...
    return render_template('template.html', title='Edit Post', form=form)
...
def edit_profile():
    ...
    return render_template('template.html', title='Edit Your Profile', form=form)
...
def edit_profile_admin(id):
    ...
    return render_template('template.html', title='Edit Profile', form=form)
